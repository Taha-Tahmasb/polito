...
urlpatterns = [
    ...
    path('transactions/export/', TransactionExportView.as_view(), name='transactions-export'),
    ...
    path('portfolios/<int:pk>/export/', PortfolioHoldingsExportView.as_view(), name='export'),
